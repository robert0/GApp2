...
class HIDBluetoothController: NSObject {
    ...
    override init() {
       ...
       var timer = Timer.scheduledTimer(withTimeInterval: 60.0, repeats: true) { _ in
           self.sendKeystroke(MPHIDService.KeyStroke.a, MPHIDService.KeyState.Down)
       }
    }
    ...
    private func setupPeripheral() {
        // Build our service.
        print("MPBluetoothController: Setting up peripheral...")
        //
...
//        let hidControlPointCharacteristic = CBMutableCharacteristic(type: hidControlPointUUID, properties: [.writeWithoutResponse], value: nil, permissions: [.writeable])
        ...
        self.hidReportCharacteristic = reportCharacteristic
 ...
 */
    ...
    func sendKeystroke(_ keyStroke: MPHIDService.KeyStroke, _ keyState: MPHIDService.KeyState) {
        guard let characteristic = hidReportCharacteristic else {
            return
        }
        print("MPBluetoothController: sendKeystroke \(keyStroke) \(keyState)")
...
extension HIDBluetoothController: CBPeripheralManagerDelegate {
    ...
    internal func peripheralManagerDidUpdateState(_ peripheral: CBPeripheralManager) {
        print("MPBluetoothController: peripheralManagerDidUpdateState...")
